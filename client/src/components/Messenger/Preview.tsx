  ...
  return (
    ...
    >
      <div className="w-full basis-20 flex justify-between items-center rounded-tl-lg px-4 shadow-lg">
        <div className="w-100">
          <div className="font-dev text-[#FF6A3D] mt-2 text-3xl">Echolink</div>
          <div className="text-gray-500 text-sm mx-2 w-100 basis-30" style={{width: "150px"}}>EPT Social App</div>
        </div>
